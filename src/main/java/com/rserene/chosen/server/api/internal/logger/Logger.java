...
public interface Logger {
   ...
   default void log(Level level, Throwable throwable) {
      this.log(level, (String)null, throwable);
   }
   ...
   default void debug(Throwable throwable) {
      this.log(Level.DEBUG, (String)null, throwable);
   }
   ...
   default void info(Throwable throwable) {
      this.log(Level.INFO, (String)null, throwable);
   }
   ...
   default void warn(Throwable throwable) {
      this.log(Level.WARN, (String)null, throwable);
   }
   ...
   default void error(Throwable throwable) {
      this.log(Level.ERROR, (String)null, throwable);
   }
}
