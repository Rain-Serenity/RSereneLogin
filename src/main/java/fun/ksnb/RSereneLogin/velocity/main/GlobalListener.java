...
import fun.ksnb.rserenelogin.velocity.impl.VelocityPlayer;
...
public class GlobalListener {
   ...
   public void onPlayerJoin(LoginEvent event) {
      HandleResult result = this.multiLoginVelocity.getRSereneLoginCoreAPI().getPlayerHandler().pushPlayerJoinGame(event.getPlayer().getUniqueId(), event.getPlayer().getUsername());
